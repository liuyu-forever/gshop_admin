  ...
  methods: {
    ...
    */
    async getRoles() {
      ...
      // 如果想要设置这个全选的框框,是全选的状态还是不全选或者是不确定是否都选中了
      // isIndeterminate这个属性值是false
      // 如果 isIndeterminate属性值是true,那么此时是全选
    ...
    */
    search() {
      // 用户输入的数据在一个临时对象的username中存储
      // 把对象中的username属性解构出来,给了searchObj属性
